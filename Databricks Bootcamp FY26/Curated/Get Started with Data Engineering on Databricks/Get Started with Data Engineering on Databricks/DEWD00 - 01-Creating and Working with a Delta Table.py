...
# MAGIC
# MAGIC ![unity_catalog_object_model](./Includes/images/uc-object-model.png)
# MAGIC
# MAGIC
...
# MAGIC %sql
# MAGIC ALTER TABLE current_employees SET TBLPROPERTIES (delta.enableChangeDataFeed = true)
...
# MAGIC %sql
# MAGIC
# MAGIC drop table if exists current_employees_clone;
# MAGIC
# MAGIC create table current_employees_clone DEEP CLONE current_employees VERSION AS OF 3 -- you can specify timestamp here instead of a version

# COMMAND ----------

# MAGIC %sql
# MAGIC
# MAGIC describe history current_employees_clone;

# COMMAND ----------

# MAGIC %sql
# MAGIC
# MAGIC drop table if exists current_employees_clone_shallow;
# MAGIC
# MAGIC -- Note that no files are copied
# MAGIC
# MAGIC create table current_employees_clone_shallow SHALLOW CLONE current_employees;

# COMMAND ----------

# MAGIC %md
# MAGIC ## G. Drop the Tables
